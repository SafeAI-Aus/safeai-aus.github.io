...
> **Purpose:** Preserve Australian judgement, accountability and security capability as advanced AI changes the threat environment<br>
...
This guidance complements the [Government and Public Institutions](index.md) guidance. It does not replace current Defence, intelligence, cyber-security or legal frameworks.
...
!!! warning "The central risk is lost judgement"
...
For this audience, [Resilience](../../preparing-for-agi/framework/resilience.md) and [Governance](../../preparing-for-agi/framework/governance.md) carry the most weight. Australia needs security functions that continue when AI is unavailable or untrusted and clear authority over where it may be used. [Containment](../../preparing-for-agi/framework/containment.md) matters mainly through protection of sensitive systems and cooperation with allies. [Alignment](../../preparing-for-agi/framework/alignment.md) becomes concrete in the systems Australia acquires and operates: reliable behaviour, meaningful human control and evaluation under adversarial conditions.
...
The formal scenarios most relevant to this audience are [Critical Infrastructure](../../preparing-for-agi/scenarios/scenario-critical-infrastructure.md), [Information Ecosystems](../../preparing-for-agi/scenarios/scenario-information-ecosystems.md), [Catastrophic Misuse](../../preparing-for-agi/scenarios/scenario-catastrophic-misuse.md) and [Loss of Control](../../preparing-for-agi/scenarios/scenario-loss-of-control.md). The exercises below translate those planning scenarios into national-security questions; they are not forecasts or operational doctrine.
...
!!! question "Use these prompts to explore strategic dependencies"
