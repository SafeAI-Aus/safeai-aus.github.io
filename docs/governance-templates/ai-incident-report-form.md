...
description: "AI incident report template for Australian businesses to document, track and respond to incidents while supporting governance and regulatory obligations."
...
og_type: "article"
howto:
  name: "How to Report an AI Incident"
  description: "Step-by-step guide to documenting, tracking and responding to AI-related incidents using this standardised form"
  totalTime: "PT30M"
  steps:
    - name: "Record incident details"
      text: "Capture the date, time, reporter details and assign an incident ID. Classify the severity as Critical, High, Medium or Low."
    - name: "Document the AI system involved"
      text: "Record the system name, version, vendor and deployment environment so the incident can be traced to its source."
    - name: "Describe the incident and assess impact"
      text: "Detail what happened, including inputs, outputs and observed issues. Assess actual or potential harm to individuals, the organisation or the public."
    - name: "Take immediate containment actions"
      text: "Document any steps already taken to contain or mitigate the incident, including workarounds applied."
    - name: "Identify root cause and follow-up actions"
      text: "Determine the likely cause and define steps to prevent recurrence. Assign ownership for each follow-up action."
    - name: "Submit for review and capture lessons learned"
      text: "Route the report through your escalation matrix for approval. Record what worked well, what could be improved and any preventive measures identified."
faq:
  - question: "When should I use this incident report form?"
    answer: "Use this form whenever an AI-related incident occurs, including unexpected errors, harmful outputs, privacy breaches, security incidents or any situation where an AI system behaves outside expected parameters."
  - question: "How quickly should AI incidents be reported?"
