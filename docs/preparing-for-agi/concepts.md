...
og_title: "AGI Concepts & Glossary - AI Safety Terminology"
og_description: "Essential AGI and AI safety terminology explained for Australian organisations preparing for advanced AI."
og_type: "article"
og_url: "https://safeaiaus.org/preparing-for-agi/concepts/"
og_image: "https://safeaiaus.org/assets/safeaiaus-logo-600px.png"
twitter_card: "summary_large_image"
twitter_title: "AGI Concepts & Glossary"
twitter_description: "Essential AGI and AI safety terminology explained for Australian organisations."
faq:
  - question: "What is AGI (Artificial General Intelligence)?"
    answer: "AGI refers to AI systems that match or exceed human cognitive capabilities across a broad range of domains, including learning, reasoning and adapting to novel situations."
  - question: "What is the difference between AGI and narrow AI?"
    answer: "Narrow AI specialises in particular tasks or domains. AGI would demonstrate broad capability and transfer knowledge effectively across novel tasks and domains."
  - question: "What does AI alignment mean?"
    answer: "AI alignment is the challenge of making AI systems reliably pursue intended goals and remain safe as capabilities scale, including setting right objectives and ensuring systems actually pursue them."
  - question: "What is frontier AI?"
    answer: "Frontier AI refers to the most capable AI systems available at a given time. Unlike AGI, it describes relative position rather than a fixed capability threshold."
tags:
  - Resources
  - Framework
---
...
!!! info "Glossary scope"
    **Looking for operational AI terms?** For day-to-day AI governance vocabulary (Australian Privacy Principles, AI risk assessment, vendor due diligence, explainability, bias testing), see the [AI Glossary (Australia)](../resources/glossary.md).
...
**Key insight:** Generative AI and AGI are not synonyms. Whether today's approaches can develop into AGI remains one of the key [unresolved debates](timelines.md).
...
- **When or if:** Public estimates range from the late 2020s to many decades away, using different definitions and evidence (see [AGI Timelines](timelines.md)).
...
**See also:** [AGI Timelines](timelines.md) for expert predictions | [Power Concentration scenario](scenarios/scenario-power-concentration.md) for how this could unfold in Australia
...
The [C·A·G·R framework](framework/index.md) therefore addresses both safety failures and transformation governance. Alignment asks whether a system follows intended goals; it does not decide whose intentions should prevail or how transformation should be governed.
...
Containment means stopping dangerous AI systems before they cause harm through:
...
If systems are trained, require safety evidence and effective controls (evaluations, licensing, AI control methods)
...
- Containment, governance and resilience are primary defences
...
- Alignment and AI control are primary defences
...
These pathways overlap and can reinforce each other. See [Scenarios for Australia](scenarios/index.md) for detailed exploration of how each could unfold in Australian context.
...
- [AGI Scenarios](scenarios/index.md) — see these concepts in action
- [Framework FAQ](framework/faq.md) — common questions about our approach

**Operational AI governance:**

- [AI Glossary (Australia)](../resources/glossary.md) — practical terms for day-to-day AI implementation
