...
SafeAI-Aus publishes at the organisation level. SafeAI-Aus, rather than any individual contributor or reviewer, is responsible for the content published on this site.

Our editorial process favours current primary sources, including legislation, government and regulator publications, and standards-body material. Secondary sources may provide context, but important claims should remain traceable to authoritative sources where they are available.

A substantive review checks the page's accuracy, currency, sources and risk wording. A substantive content change is not complete until that review has occurred and the page's `last-reviewed` date has been updated. Minor formatting changes, template changes and deployments do not advance the date.
