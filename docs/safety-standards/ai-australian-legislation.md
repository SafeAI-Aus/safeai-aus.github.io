...
!!! warning "OAIC consultation open — submissions due 15 June 2026"
    The OAIC has released an issues paper: **"Guidance for Transparency in Automated Decision Making"**, which closes **Monday 15 June 2026**. The consultation informs OAIC guidance to help APP entities understand and meet their ADM transparency obligations under APP 1 (effective 10 December 2026). Organisations subject to these obligations — particularly those using AI in decisions that significantly affect individuals — may wish to make a submission.

    Submissions by email to privacyreformtranche1@oaic.gov.au. ([oaic.gov.au consultation page](https://www.oaic.gov.au/engage-with-us/consultations/consultation-on-guidance-for-transparency-in-automated-decision-making), accessed 25 May 2026)
