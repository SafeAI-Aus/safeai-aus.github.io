...
In 2024 the Government released proposals for mandatory guardrails for high-risk AI applications alongside a Voluntary AI Safety Standard. In October 2025 the National AI Centre (NAIC) published updated **Guidance for AI Adoption**, which sets out six essential practices (AI6) and is now the primary government guidance for responsible AI governance and adoption. In December 2025 the **National AI Plan** confirmed that, for now, Australia would rely on **existing laws and sector regulators, supported by voluntary guidance and the Australian AI Safety Institute (AISI)**, rather than introducing a standalone AI Act or immediate mandatory guardrails. On **15 July 2026**, Prime Minister Albanese announced the **Australian Standards for AI** — a formal commitment to legislate mandatory national AI standards — and established a new **Office of AI** immediately within the Department of the Prime Minister and Cabinet. National Cabinet will consider the Standards in August 2026, with legislation expected in **early 2027** and staged commencement through 2027–2028. Until the legislation passes, AI6 and the technology-neutral laws below remain the operative framework for organisations. As of July 2026, the AISI is actively testing unreleased frontier AI models in collaboration with the Australian Signals Directorate and international partners — the most substantive operational milestone for the institute to date.

!!! warning "Major shift: mandatory national AI standards announced 15 July 2026"
    Prime Minister Albanese announced on 15 July 2026 that Australia will **legislate mandatory national AI standards** — ending the voluntary-only approach established under the National AI Plan. A new **Office of AI** has been established immediately within the Department of the Prime Minister and Cabinet. National Cabinet is to consider the Standards in **August 2026**; legislation is expected in **early 2027** with staged commencement through 2027–2028. Until the legislation passes, AI6 and the technology-neutral laws on this page remain operative. See [Australian Government AI Policy and Frameworks](ai-government-policy-frameworks.md) for details. ([pm.gov.au](https://www.pm.gov.au/media/ai-australias-interests), accessed 19 July 2026)
...
- 🏛️ **Australian Standards for AI — legislation expected early 2027**
  Prime Minister Albanese announced on 15 July 2026 that the Government will legislate a mandatory set of national AI standards. A new **Office of AI** has been established immediately within the Department of the Prime Minister and Cabinet to coordinate across government on AI standards. National Cabinet is to consider the Standards in **August 2026**; legislation is expected to be introduced to Parliament in **early 2027**, with staged commencement through 2027–2028. The announcement includes: (a) mandatory obligations for large AI data centre operators (underwrite own new power supply, minimise water use, reduce power during grid stress events, pay full connection costs); (b) reaffirmation that no text-and-data-mining exemption will be granted for AI training on Australian creative works; and (c) coordination across education, labour market, climate, energy, copyright and defence dimensions of AI governance. Until the legislation passes, AI6 and existing technology-neutral laws remain operative. ([pm.gov.au](https://www.pm.gov.au/media/ai-australias-interests), accessed 19 July 2026)
...
- 📝 **Copyright reform — TDM exemption rejected (April 2026; reaffirmed 15 July 2026)**
  Parliament rejected a text-and-data-mining exemption for AI training and is exploring a paid licensing model instead. Prime Minister Albanese reaffirmed this position on 15 July 2026 as part of the Australian Standards for AI announcement. See the IP section above for details. Further consultations on AI's impact on the creative sector are expected through the next National Cultural Policy process.
...
| **Australian Standards for AI (expected early 2027)** | Mandatory national AI standards announced 15 July 2026; Office of AI established in PM&C; data centre mandatory obligations confirmed; TDM copyright exemption rejected | Monitor for Office of AI consultations ahead of National Cabinet (August 2026); continue implementing AI6 until legislation passes |
