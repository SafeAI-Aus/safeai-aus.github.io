...
!!! tip "Key Regulators"
    ...
    - 🏥 **TGA (Healthcare):** AI medical devices must comply with therapeutic goods regulation. The TGA's January 2026 outcomes report on AI medical software regulation confirmed the existing technology-agnostic framework is fit for purpose for AI in therapeutic goods (91% stakeholder agreement); no new mandatory requirements introduced. The Department of Health's parallel Safe and Responsible AI in Health Care Legislation and Regulation Review (final report, January 2026) reached a similar conclusion ([tga.gov.au](https://www.tga.gov.au/news/news-articles/tga-ai-review-outcomes-report-published))
